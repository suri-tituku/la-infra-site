      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="container-site relative z-10 text-center pt-28 pb-24">
          ...
          >
            Ethical Real Estate
            <br />
            <span className="text-brand-300">Sustainable Growth</span>
            <br />
            Trusted Legacy
          </motion.h1>
          ...
          >
            Secure farmland and nature-inspired developments built on transparency,
            legal clarity, and long-term value creation across generations.
          </motion.p>
          ...
          >
            <Link
              to="/about-us"
              className="px-8 py-3 bg-brand-600 text-white rounded-sm hover:bg-brand-700 hover:scale-105 transition-all duration-300"
            >
              Discover LA Infra
            </Link>
