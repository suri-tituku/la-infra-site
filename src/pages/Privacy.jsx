...
const sections = [
  {
    ...
    content:
      "We collect information you voluntarily provide when contacting us, including your name, email address, phone number, and any message you submit. We do not collect sensitive personal data unless explicitly required.",
  },
  {
    title: "How We Use Your Information",
    content:
      "Information provided through our contact form is used solely to respond to your enquiry. We do not sell, trade, or transfer your personal information to third parties without your consent, except as required by law.",
  },
  {
    title: "Data Security",
    content:
  ...
  },
  {
    title: "Cookies",
    content:
      "Our website may use basic cookies to improve your browsing experience. You can choose to disable cookies in your browser settings without affecting core site functionality.",
  },
  {
  ...
  },
  {
    title: "Your Rights",
    content:
      "You have the right to request access to, correction of, or deletion of any personal information we hold about you. Contact us at info@lainfra.com to exercise these rights.",
  },
  {
  ...
  return (
    <>
      <SEO
        ...
        url="https://www.thelainfra.com/privacy-policy"
      ...
      <section className="bg-forest pt-32 pb-16">
        <div className="container-site">
          <SectionReveal>
            ...
            <h1 className="font-display text-display-md text-cream mb-3">
              Privacy Policy
            </h1>
        ...
        <div className="container-site max-w-3xl">
          <SectionReveal>
            <p className="text-forest/70 font-body leading-relaxed mb-10">
              LA Infra ("we," "us," or "our") is committed to protecting your
